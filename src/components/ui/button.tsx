...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:focus-visible:ring-zinc-300",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-zinc-50 shadow hover:bg-primary/90 dark:bg-primary-50 dark:text-zinc-900 dark:hover:bg-zinc-50/90",
        destructive:
        ...
        adoption: "bg-adoption shadow hover:bg-adoption/90",
        product: "bg-product shadow hover:bg-product/90",
        discuss: "bg-discuss shadow hover:bg-discuss/90",
        sale: "bg-sale shadow hover:bg-sale/90",
        help: "bg-help shadow hover:bg-help/90",
      },
      size: {

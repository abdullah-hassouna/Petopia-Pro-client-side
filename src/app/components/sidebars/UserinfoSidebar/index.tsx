...
export default function UserInfoSidebar() {
  ...
  return (
    <div
      className={cn(
        'max-w-[320px] bg-foreground overflow-hidden h-screen hidden md:flex flex-col border-r border-borderColor duration-500',
        { 'w-[15rem] sm:w-[20rem] min-w-[250px]': isOpen, 'w-[5rem] min-w-[5rem]': !isOpen }
      )}
    >
      <div className="p-4">
